...
export const discoverEmployers = async (profile: WorkforceProfile): Promise<EmployerMatch[]> => {
  ...
  Also estimate the employee count (e.g., '10-50', '500+').`;
    ...
    config: {
      ...
      responseSchema: {
        ...
        items: {
          ...
          required: ['name', 'score', 'rationale', 'segment', 'industryAlignment', 'jobTitleOverlap', 'skillOverlap', 'geographicProximity', 'hiringSignals', 'employeeCount']
        }
      }
    }
  });
